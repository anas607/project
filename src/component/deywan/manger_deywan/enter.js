  ...
  return (
    ...
    >
      ...
      <Box flex={1} p={2}>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} sm={6}>
                    <Box sx={{ mb: 3 }}>
                      ...
                      <input style={{ width: "60%", padding: "8px" }} />
                    </Box>
                  </Grid>
                ...
                <TextField
                  ...
                  sx={{
                    ...
                    input: {
                      px: 1,
                      fontSize: "13px",
                      borderBottom: "1px solid rgb(128, 125, 125) !important",
                    },
                  }}
                  InputProps={{
        ...
        <TableContainer
          sx={{ mr: 1, backgroundColor: "transparent", boxShadow: "none" }}
        >
          <Table sx={{ width: "98%" }}>
            <TableHead>
        ...
        >
          ...
          >
            ...
            <Typography fontSize="14px" fontWeight="600">
              ...
              <Box component="span" color="black">
                تعديل آلية تسليم شهادات البورد السوري
              </Box>
            </Typography>

            <Typography fontSize="14px" color="rgb(34,42,37)" mt={2}>
              بناءً على متطلبات تسهيل الإجراءات الإدارية، وحرصاً على تيسير
              استلام شهادات البورد السوري للأطباء الأخصائيين المقيمين خارج
              محافظات مراكز الهيئة، تقرر ما يلي:
            </Typography>

            <Typography fontSize="14px" color="rgb(34,42,37)" mt={1}>
              يُسمح للأطباء المتقدمين لاستلام شهادات البورد السوري بإرسال أصول
              الوثائق المطلوبة عبر البريد الرسمي
            </Typography>
            <Typography fontSize="14px" color="rgb(34,42,37)">
              أو عن طريق وكلاء قانونيون بموجب وكالات موثقة ومصدقة أصولاً، على أن
              يتم التأكد من صحة الوثائق والأصول
            </Typography>
            <Typography fontSize="14px" color="rgb(34,42,37)">
              المرسلة ومطابقتها للسجلات المعتمدة في الهيئة، و تسليم الشهادة
              للطبيب شخصياً عند حضوره إلى مقر الهيئة، أو إرسالها له عبر البريد
              الرسمي إلى العنوان المحدد بناءً على طلب خطي، و في حال الاستلام عبر
            </Typography>
            <Typography fontSize="14px" color="rgb(34,42,37)">
              وكيل، يجب إرفاق نسخة مصدقة من الوكالة القانونية الممنوحة له.
            </Typography>
            <Typography fontSize="14px" color="rgb(34,42,37)" mt={1}>
              يُعمل بهذا التعديل اعتباراً من تاريخه، ويُعمم على كافة الدوائر
              المعنية للتنفيذ بدقة.
            </Typography>
            <Typography fontSize="14px" color="rgb(34,42,37)" mt={2}>
            ...
            <Typography fontWeight="600" fontSize="14px" sx={{ mr: 54 }}>
              ...
              <Box
                component="span"
                sx={{ color: "gray", whiteSpace: "-moz-pre-wrap" }}
              >
                {" "}
                الدكتور يونس قبلان
              </Box>
