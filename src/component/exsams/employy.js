...
export default function Employee_Exam(){
                ...
                <Grid item xs={12} sm={6} md={3} key={seleectedEditEmployee.id}>
                  ...
                  >
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                      ...
                      <Typography variant="body2" color="white" sx={{fontSize:"10px",fontWeight:"600"}}>
                        {seleectedEditEmployee.name}
                      </Typography>

                       <Typography variant="body2" color="white" sx={{fontSize:"12px",fontWeight:"400"}}>
                        {seleectedEditEmployee.phone}
                      </Typography>

  <Typography  sx ={{fontSize:"10px" ,fontWeight:"400"}} variant="body2" color="white"> 
