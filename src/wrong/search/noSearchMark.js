...
import SeventeenMpIcon from '@mui/icons-material/SeventeenMp';export default function NOSearchingMark(){
    return(
        <>
        <Box
  sx={{
...
>
    <SeventeenMpIcon sx={{ fontSize: 90, color: "error.main", mb: 2 }}/>
