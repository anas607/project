...
const Enter_EShahadat= () => {
  ...
  return (
    ...
    {!isInbox && <>
     <Button onClick={()=>{
      setCreat(true)
     }} variant="contained" color="rgb(14,74,35)" sx={{borderRadius:"20px" ,width:"11%",backgroundColor:"rgb(14,74,35)",color:"white",mr:96}}>
            انشاء بريد
          </Button>
    ...
    >
      ...
      >
        ...
        />
        <Typography fontWeight="600" fontSize="14px" color="rgb(14,74,35)">
          انشاء بريد
        </Typography>
      ...
      <Grid item xs={12} sm={6}>
        ...
        <Box sx={{ mb: 3 }}>
          <Typography variant="subtitle1" sx={{ mb: 1 ,color: "black",fontSize:"14px",fontWeight: '600',}}>
             العنوان
          </Typography>
 ...
 <TextField
        ...
        <Box sx={{ display: 'flex', justifyContent: 'flex-end',mt:2 }}>
         <Button variant="contained" color="rgb(14,74,35)" sx={{borderRadius:"20px" ,width:"17%",backgroundColor:"rgb(14,74,35)",color:"white",ml:2, mt:5}}>
            انشاء
          </Button>
        </Box>
      </Paper>
...
export default Enter_EShahadat;
