...
<>  <Box sx={{ flex: 1, backgroundColor: "white", borderRadius: 2, padding: 2 }}>
      <Typography sx={{ marginLeft: "79%", fontSize: "15px", mt:1 }} variant="h5">
        البريد الداخلي
      </Typography>
      ...
      <Box display="flex" flexDirection="row" alignItems="center" justifyContent="space-between" sx={{marginTop: "-8%"}}>
        ...
        <Box>
          <Typography sx={{ fontSize: "35px", mt:2 ,color:"rgb(71,59,68)" }} variant="h5">
            897
          </Typography>

          <Typography sx={{ fontSize: "10px", marginTop: "1%", marginBottom: "5%" }} variant="h5">
            عدد معاملات البريد الداخلي
          </Typography>

          <Box display="flex" alignItems="center" mb={1}>
            <Box sx={{ width: 20, height: 8, borderRadius: "30%", backgroundColor: "rgb(71,59,68)", mr: 1 }} />
            <Typography sx={{ fontSize: "10px",mr: 1 }} variant="h5">
              من البريد المحول
            </Typography>
          </Box>

          <Box display="flex" alignItems="center" mb={1}>
            <Box sx={{ width: 20, height: 8, borderRadius: "30%", backgroundColor: "rgb(97,79,92)", mr: 1 }} />
            <Typography sx={{ fontSize: "10px", mr:1}} variant="h5">
              من البريد المرفوض
            </Typography>
          </Box>
          ...
          <Box display="flex" alignItems="center">
            <Box sx={{ width: 20, height: 8, borderRadius: "30%", backgroundColor: "rgb(141,113,133)", mr: 1 }} />
            <Typography sx={{ fontSize: "10px" ,mr: 1 }} variant="h5">
