...
export default function TabsExam({ value, handleChange }) {
  return (
    <Box
      sx={{
        width: "fit-content",
    ...
    >
      {/* الخط الرمادي الأساسي تحت كل التبويبات */}
      <Box
        sx={{
          position: "absolute",
          bottom: 0,
      ...
      >
        ...
        <Tab
          ...
          sx={{
            ...
            px: 2,
            pb: 2,
            color: value === 2 ? "rgb(14,75,35)" : "#888",
            position: "relative",
            zIndex: 2,
            "&::after": {
              content: '""',
